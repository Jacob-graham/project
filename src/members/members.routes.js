...
router.get('/:id', midd, getMemberById);

// TODO: move this func to middleware in a new file
async function midd(req, res, next) {
    try {
        const account = res.locals.account;
        console.log('account = ', account);
        // TODO: only return the member if the user doing the request is in this members hierarchy
        next();
    }
    catch (err) {
